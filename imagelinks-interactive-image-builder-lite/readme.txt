...
= 1.6.1 =
* Fixed: author changes after the update
* Fixed: empty value when controlling the item version, cause a cache issue

= 1.6.0 =
* Fixed: constant FILTER_SANITIZE_STRING is deprecated
* Fixed: SQL injection when sorting imagelinks items in "orderby" parameter
...
= 1.5.2 =
* Fixed: Bug with bodyclick (FireFox, IE)

= 1.5.1 =
* Fixed: Bug with jquery, added dependency from this library
* Fixed: Bug with marker's image, the relative property

= 1.5.0 =
* Added: Absolutely new version, incompatible with the old one

= 1.4.1 =
* Fixed: Sometimes lost hotspot's content after edit
* Fixed: Bug with JetPack lazyload
* Added: Added save/load item config to file

= 1.4.0 =
* Fixed: Changed a data storage format
* Added: Ready for translation

= 1.3.5 =
* Fixed: Bug with multiple instances on one page

= 1.3.4 =
* Fixed: Works better with touch events

= 1.3.3 =
* Fixed: Bug with char encoding, problems with item update
* Added: Allow execute JS code after the item loaded

= 1.3.2 =
* Fixed: Bug with hotspot preview images

= 1.3.1 =
* Added: Image url can be local relative to the upload folder or full
* Fixed: Editor can't save a popover content in some cases

= 1.3.0 =
* Added: Added WordPress editor for a popover content
* Added: Allow move hotspots via arrow keys
* Added: Now you can add your own theme to plugin folder

= 1.2.0 =
* Added: Added a new parameter 'popoverLazyload'
* Added: Added a new parameter 'popoverShow'
* Added: Allow shortcodes within a popover content
* Fixed: When special characters are used in popovers the plugin doesn't work

= 1.1.0 =
* Added: Added a new theme 'dots'
* Added: Added a new parameter 'hotSpotBelowPopover'
* Added: Added a new parameter 'content' for the hotspot definition
* Added: Added new location types (top-left, top-right, bottom-left, bottom-right)
* Fixed: Bug with z-order of popover windows
