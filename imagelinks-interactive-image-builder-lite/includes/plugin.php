...
class ImageLinks_Builder
{
  ...
  function admin_notices_picpoints()
  {
    ...
    $page = sanitize_key(filter_input(INPUT_GET, 'page', FILTER_DEFAULT));
    if (!($page === 'imagelinks' || $page === 'imagelinks_item' || $page === 'imagelinks_settings')) {
      return;
    }
    ...
    echo '<div class="notice notice-info imagelinks-picpoints-notice" style="position:relative;margin-left:0;">';
    ...
    echo '</p>';
    echo '<p style="margin-bottom:10px;">';
    echo esc_html__('Why you will love it:', 'imagelinks');
    echo '</p>';
    echo '<p>';
    echo esc_html__('✅ Easy-to-use editor - place markers, draw shapes and add polygons just like in Figma.', 'imagelinks');
    echo '</p>';
    echo '<p>';
    echo esc_html__("✅ No theme conflicts - your maps always look perfect and won't break your site's design.", 'imagelinks');
    echo '</p>';
    echo '<p>';
    echo esc_html__('✅ Fast & smooth - works flawlessly even with large floor plans or interactive product catalogs.', 'imagelinks');
    echo '</p>';
    echo '</div>';

    echo '<style>@media(max-width:1279px){.imagelinks-mod-hide{display:none!important}}</style>';
    echo '<iframe class="imagelinks-mod-hide" style="padding:10px; box-sizing: border-box; border-radius:5px; box-shadow: 0 0 2px rgba(0, 0, 0, .7); height:240px; width:auto; aspect-ratio:16/9;" src="https://www.youtube.com/embed/_HStw93NAf8" frameborder="0" allow="encrypted-media; web-share" allowfullscreen></iframe>';
